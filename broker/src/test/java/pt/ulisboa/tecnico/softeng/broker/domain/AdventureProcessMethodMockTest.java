...
public class AdventureProcessMethodMockTest {
	...
	@Test
	public void reserveHotelHotelException(@Mocked final BankInterface bankInterface,
			@Mocked final HotelInterface hotelInterface, @Mocked final ActivityInterface activityInterface){
		new Expectations() {
			{
				BankInterface.processPayment(IBAN, 300);
	...
	@Test
	public void reserveActivityActivityException(@Mocked final BankInterface bankInterface,
			@Mocked final ActivityInterface hotelInterface, @Mocked final ActivityInterface activityInterface){
		new Expectations() {
			{
				BankInterface.processPayment(IBAN, 300);
				this.result = PAYMENT_CONFIRMATION;
